    ...
    getProducts()
      .then((result) => {
        const tabletProducts = result.filter(
          (product: IProduct) => product.category === "شارژر"
        );
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              <h2 className="text-3xl font-semibold text-gray-800 mt-8 mb-8">
                شارژرهایی برای سرعت و کارایی بیشتر
              </h2>

              <p className="mt-4 max-w-md text-gray-500">
                با شارژرهای سریع و باکیفیت ما، دیگر هیچ‌گاه برای شارژ دستگاه‌های
                خود معطل نخواهید ماند. از شارژرهای کوچک و قابل حمل تا مدل‌های
                قدرتمندتر، ما گزینه‌هایی را برای شما فراهم کرده‌ایم که به شما
                کمک می‌کند همیشه با انرژی کامل باشید.
              </p>
            </header>
...
export default CollectionCharger;
