          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              <h2 className="text-3xl font-semibold text-gray-800 mt-8 mb-8">
                گوشی‌های هوشمند برای هر نیاز و سلیقه‌ای
              </h2>

              <p className="mt-4 max-w-md text-gray-500">
                گوشی‌های هوشمند ما بهترین تجربه را برای کار، سرگرمی و ارتباطات
                به شما می‌دهند. از مدل‌های پیشرفته برای علاقه‌مندان به تکنولوژی
                گرفته تا گزینه‌های مقرون به صرفه برای استفاده‌های روزمره، هر نوع
                نیاز و بودجه‌ای را پوشش می‌دهیم.
              </p>
            </header>
...
export default CollectionPhone;
