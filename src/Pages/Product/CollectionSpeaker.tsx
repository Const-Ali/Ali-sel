          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              <h2 className="text-3xl font-semibold text-gray-800 mt-8 mb-8">
                اسپیکرهای با کیفیت برای صدای عالی
              </h2>

              <p className="mt-4 max-w-md text-gray-500">
                تجربه صدای واضح و شفاف را با اسپیکرهای ما تجربه کنید. چه به
                دنبال اسپیکری برای مهمانی‌ها باشید، چه برای گوش دادن به موسیقی
                در خانه، ما محصولات با کیفیت و با صدای عالی برای تمام نیازهای
                شما داریم. طراحی‌های مدرن و تکنولوژی پیشرفته، هر لحظه از موسیقی
                را به یک تجربه خاص تبدیل می‌کنند.
              </p>
            </header>
