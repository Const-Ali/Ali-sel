    ...
    getProducts()
      .then((result) => {
        const tabletProducts = result.filter(
          (product: IProduct) =>
            product.category === "هندزفری-سامسونگ" ||
            product.category === "هندزفری-اپل" ||
            product.category === "هندزفری-هایلو" ||
            product.category === "هندزفری-شیائومی"
        );
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
              <h2 className="text-3xl font-semibold text-gray-800 mt-8 mb-8">
                ایرپادهایی برای تجربه‌ی صوتی بی‌نظیر
              </h2>

              <p className="mt-4 max-w-md text-gray-500">
                ایرپادهای ما با طراحی‌های مدرن و کیفیت صدای استثنایی، تجربه‌ی
                شنیداری شما را به سطحی جدید می‌برند. چه برای ورزش، چه برای تمرکز
                در محیط کار، ما گزینه‌هایی داریم که با هر نیازی همخوانی داشته
                باشد.
              </p>
            </header>
...
export default CollectionAirPods;
